...
// func ChangeBackgroundNASA(imgItem config.Image) error {
// 	background, year, month, day := calcDate()
...
// 		pic = "https://apod.nasa.gov/apod/" + pic
// 	}
// 	background = downloadNASAPic(pic, imgItem.Operation+"Choice", wppFolder, imgItem)
// 	if background != "" {
...
// func getImgTagsFromIframe(url string) ([]string, error) {
...
// 		chromedp.WaitVisible(`img`, chromedp.ByQuery), // Wait for an img tag to be visible
...
// // func extractNASAImageURLs(imgItem config.Image) ([]string, error) {
...
// func downloadNASAPic(url string, fileName string, folder string, img config.Image) string {
// 	//flickr issue
// 	urlFiltered := ""
// 	ext := ""
// 	urlFiltered = url
...
// 	if err != nil {
// 		log.Println("Error could not create file:", fname, " Error:", err)
// 		return ""
// 	}
// 	defer f.Close()
